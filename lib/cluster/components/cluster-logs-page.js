  ...
  return /* @__PURE__ */ jsx(ChatNavProvider, { value: navProvider, children: /* @__PURE__ */ jsxs(SidebarProvider, { children: [
    ...
    /* @__PURE__ */ jsx(SidebarInset, { children: /* @__PURE__ */ jsxs("div", { className: "flex h-svh flex-col overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 min-h-0", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-56 shrink-0 border-r border-border overflow-y-auto bg-muted/30", children: [
          /* @__PURE__ */ jsx("div", { className: "px-3 py-2 text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Roles" }),
          logData.length === 0 ? /* @__PURE__ */ jsx("div", { className: "px-3 py-4 text-xs text-muted-foreground", children: "No logs yet" }) : logData.map((role) => /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => setSelectedRole(role.roleShortId),
              className: `w-full text-left px-3 py-2.5 text-sm transition-colors border-l-2 ${selectedRole === role.roleShortId ? "border-l-foreground bg-muted/60 text-foreground" : "border-l-transparent text-muted-foreground hover:text-foreground hover:bg-muted/40"}`,
              children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground mt-0.5 flex items-center gap-2", children: [
                      ...
                      s.startedAt && !s.endedAt && /* @__PURE__ */ jsx("span", { className: "text-yellow-600 dark:text-yellow-400", children: "in progress" })
                    ] })
                  ] })
                ]
              }
...
function SessionTabContent({ content, tab }) {
  ...
  if (tab === "prompt") {
    if (!content.prompt) {
      return /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-center py-4", children: "No prompt saved" });
    }
    return /* @__PURE__ */ jsx("pre", { className: "text-foreground whitespace-pre-wrap break-words leading-relaxed", children: content.prompt });
  }
  if (tab === "trigger") {
    if (!content.trigger) {
