...
function RoleTabContent({ role, clusterId, status, onUpdate, onDelete }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsx("label", { className: "text-sm font-medium block mb-1", children: "Role Prompt" }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto px-6 py-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mb-3", children: "Use these in system prompt and role prompt fields. Case-insensitive. Resolved at container launch." }),
